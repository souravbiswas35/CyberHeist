...
public class EncryptionController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        toolImage.setImage(new Image("file:D:/JavaFx Projects/CyberHeist/img/Encryption.jpg"));
        toolDescription.setText("Encryption Vault: An advanced defense system that blocks incoming attacks and filters suspicious traffic.\n" +
                "Smart, adaptive, and your first line of protection against intruders.");
    }
    ...
    private void loadToolData() {
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            ps.setString(1, "Encryption Vault");
            ...
            if (rs.next()) {
                ...
                showAlert(Alert.AlertType.ERROR, "Tool Not Found", "Encryption Vault tool not found in database.");
                toolId = -1;
    ...
    private void handleBuyTool() {
        ...
        try {
            ...
            showAlert(Alert.AlertType.INFORMATION, "Purchase Successful",
                    "You have purchased Encryption Vault for " + toolCost + " coins!");
            updateUI();
