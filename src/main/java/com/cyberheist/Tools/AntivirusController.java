...
public class AntivirusController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        toolImage.setImage(new Image("file:D:/JavaFx Projects/CyberHeist/img/Antivirus.jpg"));

        toolDescription.setText("Antivirus: Scans and detects malicious software, stopping threats before they can cause harm.\n" +
                "Your digital bodyguard, always ready to defend against viruses and malware.");
    }
    ...
    private void loadToolData() {
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            if (rs.next()) {
                ...
                showAlert(Alert.AlertType.ERROR, "Tool Not Found", "Antivirus tool not found in database.");
                toolId = -1;
    ...
    private void handleBuyTool() {
        ...
        try {
            ...
            showAlert(Alert.AlertType.INFORMATION, "Purchase Successful",
                    "You have purchased Antivirus for " + toolCost + " coins!");
            updateUI();
