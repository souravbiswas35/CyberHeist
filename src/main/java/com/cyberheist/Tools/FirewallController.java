...
public class FirewallController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        toolImage.setImage(new Image("file:D:/JavaFx Projects/CyberHeist/img/FireWall.jpg"));
        toolDescription.setText("FireWall Pro: An advanced defense system that blocks incoming attacks and filters suspicious traffic.\n" +
    ...
    private void loadToolData() {
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            if (rs.next()) {
                ...
                showAlert(Alert.AlertType.ERROR, "Tool Not Found", "Firewall Pro tool not found in database.");
                toolId = -1;
    ...
    private void handleBuyTool() {
        ...
        try {
            ...
            showAlert(Alert.AlertType.INFORMATION, "Purchase Successful",
                    "You have purchased Firewall Pro for " + toolCost + " coins!");
            updateUI();
