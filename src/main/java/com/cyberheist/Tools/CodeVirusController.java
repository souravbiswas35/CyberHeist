...
public class CodeVirusController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        toolImage.setImage(new Image("file:D:/JavaFx Projects/CyberHeist/img/CodeVirus.jpg"));
    ...
    private void loadToolData() {
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            if (rs.next()) {
                ...
                showAlert(Alert.AlertType.ERROR, "Tool Not Found", "Code Virus tool not found in database.");
                toolId = -1;
    ...
    private void handleBuyTool() {
        ...
        try {
            ...
            showAlert(Alert.AlertType.INFORMATION, "Purchase Successful",
                    "You have purchased Code Virus for " + toolCost + " coins!");
            updateUI();
