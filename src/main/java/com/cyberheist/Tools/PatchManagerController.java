...
public class PatchManagerController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        toolImage.setImage(new Image("file:D:/JavaFx Projects/CyberHeist/img/PatchManager.jpg"));
        toolDescription.setText("Patch Manager: Keeps your software up to date by automatically applying security fixes and updates.\n" +
                "Closes vulnerabilities before hackers can exploit them—your system’s best maintenance tool.");
    }
    ...
    private void loadToolData() {
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            if (rs.next()) {
                ...
                showAlert(Alert.AlertType.ERROR, "Tool Not Found", "Patch Manager tool not found in database.");
                toolId = -1;
    ...
    private void handleBuyTool() {
        ...
        try {
            ...
            showAlert(Alert.AlertType.INFORMATION, "Purchase Successful",
                    "You have purchased Patch Manager for " + toolCost + " coins!");
            updateUI();
